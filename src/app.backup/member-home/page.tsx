            ...
            <div className="border-t pt-2 mt-3 grid grid-cols-2 gap-4 text-xs">
              {lastEventData.front9_winner && (
                <div>
                  ...
                  <p className="font-bold text-gray-900">{lastEventData.front9_winner.name}</p>
                  <p className="text-gray-500">{lastEventData.front9_winner.points} pts</p>
                </div>
              )}
              {lastEventData.back9_winner && (
                <div>
                  <p className="text-gray-600 font-medium">Back 9</p>
                  <p className="font-bold text-gray-900">{lastEventData.back9_winner.name}</p>
                  <p className="text-gray-500">{lastEventData.back9_winner.points} pts</p>
                </div>
              )}
            </div>
