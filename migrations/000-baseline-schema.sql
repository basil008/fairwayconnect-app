-- BASELINE SCHEMA — every canonical table as CREATE TABLE IF NOT EXISTS.
-- Runs first (000) so later ALTER migrations always find their tables,
-- regardless of how old or partial the target database is.
-- On databases that already have all tables (e.g. production Turso),
